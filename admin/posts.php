...
if (isset($_GET['edit-id'])) {
	...
	if (isset($_POST['submit'])) {
        ...
        $edit_sql = mysqli_query($connect, "UPDATE posts SET title='$title', slug='$slug', image='$image', active='$active', featured='$featured', date='$date', time='$time', category_id='$category_id', content='$content' WHERE id='$id'");
        echo '<meta http-equiv="refresh" content="0;url=posts.php">';
    }
?>
	<div class="card mb-3">
		...
		<div class="card-body">
			<form name="post_form" action="" method="post" enctype="multipart/form-data">
				<p>
					<label>Title</label>
					<input class="form-control" class="form-control" name="title" id="title" type="text" value="<?php
echo $row['title'];
